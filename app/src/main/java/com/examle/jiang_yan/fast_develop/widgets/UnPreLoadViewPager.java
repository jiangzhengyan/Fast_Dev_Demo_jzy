...
/**
 * Created by jiang_yan on 2017/6/28.
 *
 *  不预加载的viwepager
 */

public class UnPreLoadViewPager extends ViewGroup {
...
//     * every method of {@ link android.support.v4.view.LazyViewPager.OnPageChangeListener}.
    ...
    public UnPreLoadViewPager(Context context) {
        super(context);
        initViewPager();
    }

    public UnPreLoadViewPager(Context context, AttributeSet attrs) {
        super(context, attrs);
        initViewPager();
    }

...
public class StrUtils {
    ...
    public static String getIpCountry() {
        ...
        try {
            ...
            TelephonyManager mTelephonyManager = (TelephonyManager) App
                    .getAppInstance().getSystemService(Context.TELEPHONY_SERVICE);
    ...
    public static String getIpBaseStation() {
        TelephonyManager telMgr = (TelephonyManager) App
                .getAppInstance().getSystemService(Context.TELEPHONY_SERVICE);
        int cid = 0;
        int lac = 0;
        try {
    ...
    public static String getAndroidId() {
        ...
        return Settings.Secure.getString( App
                .getAppInstance()
    ...
    public static int getIpAddress() {
        ...
        WifiManager wifiManager = (WifiManager)  App
                .getAppInstance().getSystemService(Context.WIFI_SERVICE);

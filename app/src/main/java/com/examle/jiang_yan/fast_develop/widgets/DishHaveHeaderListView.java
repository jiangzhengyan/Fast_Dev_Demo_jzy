 ...
 * 描述：    带有标题的ListView
 */
public class DishHaveHeaderListView extends ListView implements AbsListView.OnScrollListener {
    //滑动监听
    ...
    public DishHaveHeaderListView(Context context) {
        super(context);
        super.setOnScrollListener(this);
    }

    public DishHaveHeaderListView(Context context, AttributeSet attrs) {
        super(context, attrs);
        super.setOnScrollListener(this);
    }

    public DishHaveHeaderListView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    public static abstract class OnItemClickListener implements AdapterView.OnItemClickListener {
        ...
        public void onItemClick(AdapterView<?> parent, View view, int rawPosition, long id) {
            CustomDishLVBaseAdapter adapter;
            if (parent.getAdapter().getClass().equals(HeaderViewListAdapter.class)) {
                ...
                adapter = (CustomDishLVBaseAdapter) wrapperAdapter.getWrappedAdapter();
            } else {
                adapter = (CustomDishLVBaseAdapter) parent.getAdapter();
            }
